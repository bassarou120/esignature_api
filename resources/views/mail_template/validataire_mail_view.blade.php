                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                <div class="text">
                                    <h3> [$name], [$sending_auth] vous a ajouté comme validataire du document [$doc_title].
                                        [$sending_expiration]
                                    </h3>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <div class="text-author">
                                    ...
                                    <p><a href="[$app_url]/api/sendings/doc/validate/[$id_sending]/[$id_validataire]" class="btn btn-primary">Signer maintenant</a></p>
                                </div>
                                <div>
