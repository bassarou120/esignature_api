                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                <div class="text">
                                    <h3>Bonjour Monsieur/Madame [$sending_auth] aimerait que vous vous joigniez à son équipe.
                                    </h3>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align: center;">
                                <div class="text-author">
                                    <p><a href="[$app_url]/api/sendings/member/accept/request/[$id_member]" class="btn btn-primary">Joindre</a></p>
                                </div>
                                <div>
